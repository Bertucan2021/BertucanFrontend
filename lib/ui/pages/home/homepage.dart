...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final date = '$day ${monthsInYear[month]}, $year';
                    ...
                    children:[ CircularPercentIndicator(
                      ...
                      center:  Column(
                        ...
                        children:  [
                          ...
                          Text(cycleDate,  style: const TextStyle(color: Colors.white, fontSize: 35),)
                        ],
                      ),
                      ...
                      Column(
                        ...
                        children: [
                          const Text('Luteal Phase',style: TextStyle(color: Colors.white, fontSize: 30, overflow: TextOverflow.ellipsis),),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: const [
                              Text('Chance of Pregnancy: ', style: TextStyle(color: Colors.white70, fontSize: 18, overflow: TextOverflow.ellipsis),),
                              Text("LOW", style: TextStyle(color: Colors.white, fontSize: 20, overflow: TextOverflow.ellipsis),)
                            ],
                          )
                        ],
                      ),
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildViews('Period In', '5', 'Days', const Color(0xFF56C9C2)),
                      const SizedBox(width: 15,),
                          ...
                          child:  SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children:  const [
                                  Flexible(child: Text("Today's", maxLines: 1 , overflow: TextOverflow.fade,softWrap: false,style: TextStyle(),)),
                                  Flexible(child: Text('Cycle Day', maxLines: 1 , overflow: TextOverflow.fade,softWrap: false,style: TextStyle(),)),
                          ...
                          child:  SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children:  const [
                                  Flexible(child: Text("Chance of", maxLines: 1 , overflow: TextOverflow.fade,softWrap: false,style: TextStyle(),)),
                                  Flexible(child: Text('getting', maxLines: 1 , overflow: TextOverflow.fade,softWrap: false,style: TextStyle(),)),
                                  Flexible(child: Text('pregnant', maxLines: 1 , overflow: TextOverflow.fade,softWrap: false,style: TextStyle(),)),

                                  Text('LOW', style: TextStyle(fontSize: 28,color: Colors.white, fontFamily: 'Poppins Bold'),)
                                ],
                              ),
                            ),
                          ),
